-- =============================================================================
-- GastroVoyage — Seed: development users (Vusal, Sakina)
-- Idempotent: re-running will not duplicate users or visits.
-- Passwords: both users get "gastrovoyage" — for local/dev use only.
-- =============================================================================
...
begin
  ...
  -- Make sure profile rows exist (trigger should have handled it, but be safe).
